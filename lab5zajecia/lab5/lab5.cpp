...
Student(string n, string im, int in) : Osoba(n, im)
    ...
    virtual void drukuj() override
        {
            cout << "Student: " << getNazwisko() << " " << getImie() << " indeks: " << indeks << endl;
        }
...
class StudentZaoczny : public Student
{
    ...
    public:
        StudentZaoczny(string n, string im, int in) : Student(n, im, in)
        {}

        virtual void drukuj() override
    {
        cout << "Student zaoczny: " << getNazwisko() << " " << getImie() << " indeks: " << getIndeks() << endl; 
...
class Stazysta : public Osoba 
{
    ...
    Stazysta(string n, string im, int id) : Osoba(n, im)
    {
        ...
        virtual void drukuj() override
    {
        cout << "Stażysta: " << getNazwisko() << " " << getImie() << " indeks: " << nr_id << endl; 
        
        }
    virtual void wyswietl() override
    {
      cout << "Stażysta: " << getNazwisko() << " " << getImie() << " indeks: " << getId() << endl;
    }
    ...
    for (int i = 0; i < ilosc_osob; i++)
    {
        if (tablicaOsob[i] == nullptr)
        {
            switch(typ_osoby)
            {
                ...
                case 3:
                tablicaOsob[i] = new StudentZaoczny(nazwisko, imie, indeks);
                break; 
...
void drukujWszystkich()
    ...
    cout << "6: Drukuj wszystkie osoby z bazy\n";
    cout << "7: Zakoncz\n";
    cout << "Wybrana opcja: \n";
    ...
    cout << "Podaj imie: \n";
    cin >> t_imie;
    if (t_typ_osoby == 1 || t_typ_osoby == 3)
    {
